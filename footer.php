...
?>
	...
	<footer id="colophon" class="site-footer">
		...
		<div class="site-info grid col-span-3">
			<div class="footer-info">
				<div>
					<div class="footer-time">
						<span>Mon-Fri  9 AM - 7 PM</span> 
						<span>Sat  10 AM - 1 PM</span>
						<span>Online requests - 24/7</span> 
						<p style="margin: 1em 0em;">Our company provides fencing services in Niagara, Hamilton, Toronto, and the entire GTA.</p>
					</div>
					<div class="footer-links">
						<a href="mailto:kolosok.inc@gmail.com">kolosok.inc@gmail.com</a>
						<a href="tel:+16474959727" class="phone-number">+1 647 495 9727</a> 
					</div>
				</div>
				
			</div>
			<div class="footer-cta">
				<div class="popmake-26 pum-trigger">
					<a class="get-quote" href="#">
						get a quote
					</a>
				</div>
				
			</div>
			<div id="contact-us" class="footer-rightcol">
				<div>
					<div class="all-rights">
					  FENCE SQUAD<br>
					  Office Address:<br>
					  386 St. Paul St., Suite 102, St. Catharines, ON<br>
					  (By appointment only)<br>
					  © All Rights Reserved
					</div>
					<div>
						<p style="margin: 1em 0em; text-decoration: underline;"><a target="_blank" href="https://www.fencesquad.ca/wp-content/uploads/2025/08/Warranty.pdf">Warranty Terms</a></p>
						<p style="margin: 1em 0em;">Fence Squad is a registered trademark owned by Kolosok Construction and Landscaping Inc.</p>
					</div>
				</div>	
